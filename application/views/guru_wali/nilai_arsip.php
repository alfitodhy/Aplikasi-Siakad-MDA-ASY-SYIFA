            ...
            $(document).ready(function() {
                $('#newjenis').change(function() {
                    ...
                    $(document).on('click', '#setcancelarchive', function() {
                        const href = '<?= base_url('walikelas/nilai/archive_cancel') ?>' + `?id_kelas=${idKelas}&id_mapel=${idMapel}&id_kd=${idKd}&nilai=${jenisNilai}&oldjenis=${oldJenisTugas}&newjenis=${newJenisTugas}`;
